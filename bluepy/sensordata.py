...
def main():
    ...
    parser.add_argument('-o', "--host",  action='store', type=str, default='24:71:89:06:97:86', help='MAC of BT device')
    ...
    print('accelerometer: ' + str(arg.accelerometer))
    print('magnetometer: ' + str(arg.magnetometer))
